...
// ওপরের মেনু থেকে Console ট্যাবে ক্লিক করুন। ২. নিচে খালি জায়গায় এই কোডটি লিখুন (বা কপি করে পেস্ট করুন): localStorage.setItem('isMasterAdmin', 'true') ৩. কিবোর্ড থেকে Enter চাপুন। atar madomea real manager or admin sob kortea parbea

// লক সরাবেন কিভাবে? যদি আবার লক করতে চান, তবে কনসোলে লিখবেন: localStorage.removeItem('isMasterAdmin') এবং রিফ্রেশ দেবেন। atta madomea login korta parbea kintu edit kortea parbea na
